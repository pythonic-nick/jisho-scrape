...
while page_num <= final_num:
	...
	page = urlopen("http://jisho.org/api/v1/search/words?keyword=%23jlpt-n3&page=" + str(page_num))
...
filename = "jlptn3-scrape-output.txt" # The output file name.
